...
public class HistoriaDiagnosticoDAO {
    ...
    public static List<String> recuperarNombresHistoriaDiagnosticos( int id_historia) {
        ...
        Query query = session.createQuery(
                "SELECT concat(d.diaCodigoCie,' - ', d.diaDescripcionCie) FROM HistoriaDiagnostico hd, Historias h,Diagnosticos d \n" +
     ...
     * @return
     */
    public static HistoriaDiagnostico recuperarHistoriaDiagnosticoListener(String dia_Codigo_Cie, String dia_descripcion_cie, int id_historia) {
